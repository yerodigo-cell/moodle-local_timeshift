...
$string['pro_description'] = 'افتح الميزات المتقدمة لإدارة أنشطة دورتك بكفاءة أكبر.';
$string['pro_feature_availability_desc'] = 'قم بتغيير حالة الرؤية، الوضع المخفي، أو إخفاء عشرات الأنشطة بسرعة.';
$string['pro_feature_availability_title'] = 'إدارة التوفر';
$string['pro_feature_deletion_desc'] = 'حدد واحذف الأنشطة بشكل جماعي مع تأكيد الأمان لمنع فقدان البيانات.';
$string['pro_feature_deletion_title'] = 'حذف آمن';
$string['pro_feature_dragdrop_desc'] = 'أعد ترتيب الأنشطة داخل أقسامك باستخدام واجهة حديثة للسحب والإفلات.';
$string['pro_feature_dragdrop_title'] = 'السحب والإفلات';
$string['pro_feature_filtering_desc'] = 'اعثر على الأنشطة التي تريد تعديلها في ثوانٍ من خلال التصفية حسب النوع أو الحالة.';
$string['pro_feature_filtering_title'] = 'تصفية قوية';
$string['pro_feature_findreplace_desc'] = 'ابحث وعدل النص في أسماء جميع الأنشطة. مثالي لتحديث السنوات.';
$string['pro_feature_findreplace_title'] = 'بحث واستبدال';
$string['pro_feature_restrictions_desc'] = 'قم بتعيين أو إزالة قيود الوصول بشكل جماعي من خلال قائمة مركزية بديهية.';
$string['pro_feature_restrictions_title'] = 'التحكم في القيود';
$string['pro_feature_shift_desc'] = 'قم بتغيير تواريخ الاستحقاق والبدء والإغلاق لجميع أنشطتك للأمام أو للخلف في ثوانٍ.';
$string['pro_feature_shift_title'] = 'تغيير جماعي';
$string['pro_installed'] = 'لقد قمت بتثبيت إصدار <strong>Pro</strong>! استمتع بجميع الميزات بلا حدود.';
$string['pro_subtitle'] = 'انسَ تعديل كل نشاط على حدة. يوفر لك TimeShift ساعات من الإعداد.';
$string['pro_title'] = 'الترقية إلى Timeshift Pro';
$string['pro_title_part1'] = 'مصمم من أجل';
$string['pro_title_part2'] = 'الإنتاجية';
...
$string['type'] = 'النوع';
$string['upgrade_button'] = 'الترقية إلى Pro';
$string['visible'] = 'مرئي';
$string['weeks'] = 'أسابيع';
