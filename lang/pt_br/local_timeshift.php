...
$string['pro_description'] = 'Desbloqueie recursos avançados para gerenciar as atividades de seus cursos com mais eficiência.';
$string['pro_feature_availability_desc'] = 'Altere o status de visibilidade, o modo invisível ou oculte dezenas de atividades rapidamente.';
$string['pro_feature_availability_title'] = 'Gerenciamento de Disponibilidade';
$string['pro_feature_deletion_desc'] = 'Selecione e exclua atividades em massa com confirmação de segurança para evitar perda acidental de dados.';
$string['pro_feature_deletion_title'] = 'Exclusão Segura';
$string['pro_feature_dragdrop_desc'] = 'Reordene atividades dentro de suas seções e tópicos usando uma interface moderna de Arrastar e Soltar.';
$string['pro_feature_dragdrop_title'] = 'Arrastar e Soltar';
$string['pro_feature_filtering_desc'] = 'Encontre as atividades exatas que deseja modificar em segundos, filtrando por tipo ou status.';
$string['pro_feature_filtering_title'] = 'Filtragem Poderosa';
$string['pro_feature_findreplace_desc'] = 'Encontre e modifique texto nos nomes de todas as atividades. Perfeito para atualizar anos ("Exame 2026" para "Exame 2027").';
$string['pro_feature_findreplace_title'] = 'Localizar e Substituir';
$string['pro_feature_restrictions_desc'] = 'Atribua ou remova restrições de acesso em massa usando um menu intuitivo e centralizado.';
$string['pro_feature_restrictions_title'] = 'Controle de Restrições';
$string['pro_feature_shift_desc'] = 'Mova as datas de entrega, início e fim de todas as suas atividades ou seleções específicas para frente ou para trás em segundos.';
...
$string['pro_subtitle'] = 'Esqueça a edição de atividade por atividade. O TimeShift economiza horas de configuração.';
$string['pro_title'] = 'Atualizar para Timeshift Pro';
$string['pro_title_part1'] = 'Projetado para';
