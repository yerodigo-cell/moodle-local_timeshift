...
$string['pro_description'] = 'Schalten Sie erweiterte Funktionen frei, um Ihre Kursaktivitäten effizienter zu verwalten.';
$string['pro_feature_availability_desc'] = 'Ändern Sie den Sichtbarkeitsstatus, den Stealth-Modus oder verbergen Sie Dutzende von Aktivitäten schnell.';
$string['pro_feature_availability_title'] = 'Verfügbarkeitsverwaltung';
$string['pro_feature_deletion_desc'] = 'Wählen und löschen Sie Aktivitäten massenhaft mit Sicherheitsbestätigung, um versehentlichen Datenverlust zu verhindern.';
$string['pro_feature_deletion_title'] = 'Sichere Löschung';
$string['pro_feature_dragdrop_desc'] = 'Ordnen Sie Aktivitäten innerhalb Ihrer Abschnitte und Themen mit einer modernen Drag & Drop-Oberfläche neu an.';
$string['pro_feature_dragdrop_title'] = 'Drag & Drop';
$string['pro_feature_filtering_desc'] = 'Finden Sie die genauen Aktivitäten, die Sie ändern möchten, in Sekundenschnelle, indem Sie nach Typ oder Status filtern.';
$string['pro_feature_filtering_title'] = 'Leistungsstarke Filterung';
$string['pro_feature_findreplace_desc'] = 'Suchen und ändern Sie Text in den Namen aller Aktivitäten. Perfekt für die Aktualisierung von Jahren ("Prüfung 2026" zu "Prüfung 2027").';
$string['pro_feature_findreplace_title'] = 'Suchen und Ersetzen';
$string['pro_feature_restrictions_desc'] = 'Weisen Sie Zugriffsbeschränkungen mit einem intuitiven, zentralen Menü in großen Mengen zu oder entfernen Sie diese.';
$string['pro_feature_restrictions_title'] = 'Einschränkungskontrolle';
$string['pro_feature_shift_desc'] = 'Verschieben Sie Fälligkeits-, Start- und Enddaten aller Aktivitäten oder bestimmter Auswahlen in Sekundenschnelle vor oder zurück.';
$string['pro_feature_shift_title'] = 'Massenverschiebung';
...
$string['pro_subtitle'] = 'Vergessen Sie die Bearbeitung jeder einzelnen Aktivität. TimeShift spart Ihnen Stunden an Konfigurationszeit.';
$string['pro_title'] = 'Auf Timeshift Pro upgraden';
$string['pro_title_part1'] = 'Entwickelt für';
$string['pro_title_part2'] = 'Produktivität';
...
$string['type'] = 'Typ';
$string['upgrade_button'] = 'Auf Pro upgraden';
