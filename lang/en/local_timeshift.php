...
$string['action_shift_dates_all'] = 'This action will shift the dates for all the activities.';
...
$string['discardchangeswarning'] = 'Are you sure you want to discard all unsaved changes?';
...
$string['pagedescription_help'] = 'Manage open dates and close dates for course activities.<br><br>Use the search to find specific items.';
...
$string['privacy:metadata'] = 'The Timeshift plugin does not store any personal data.';
...
$string['shiftmodaltitle_help'] = 'Use this tool to shift all activity dates forward or backward by a specific number of days. This is extremely useful when reusing a course from a previous semester or year.<br><br><b>Note:</b> If an activity does not have a date configured, this action will not apply to it.';
