...
$string['discardchangeswarning'] = 'Tem a certeza que deseja descartar todas as alterações não guardadas?';
$string['domore'] = 'Descobrir Pro';
...
$string['errorajax'] = 'Erro AJAX ao atualizar os registos.';
...
$string['license_inactive_ajax'] = 'Licença inativa. Por favor, ative a sua licença nas configurações do plugin para guardar as alterações.';
$string['license_inactive_desc'] = 'Para usar o Timeshift, ative a sua licença nas configurações do plugin.';
...
$string['license_key_desc'] = 'Insira a sua chave de licença para ativar o Timeshift.';
...
$string['pro_description'] = 'Desbloqueie funcionalidades avançadas para gerir as atividades dos seus cursos de forma mais eficiente.';
$string['pro_feature_availability_desc'] = 'Altere o estado de visibilidade, o modo invisível ou oculte dezenas de atividades rapidamente.';
$string['pro_feature_availability_title'] = 'Gestão de Disponibilidade';
$string['pro_feature_deletion_desc'] = 'Selecione e elimine atividades em massa com confirmação de segurança para evitar a perda acidental de dados.';
$string['pro_feature_deletion_title'] = 'Eliminação Segura';
$string['pro_feature_dragdrop_desc'] = 'Reordene atividades dentro de suas seções e tópicos usando uma interface moderna de Arrastar e Largar.';
$string['pro_feature_dragdrop_title'] = 'Arrastar e Largar';
$string['pro_feature_filtering_desc'] = 'Encontre as atividades exatas que pretende modificar em segundos, filtrando por tipo ou estado.';
$string['pro_feature_filtering_title'] = 'Filtragem Poderosa';
$string['pro_feature_findreplace_desc'] = 'Localize e modifique o texto nos nomes de todas as atividades. Perfeito para atualizar os anos ("Exame 2026" para "Exame 2027").';
$string['pro_feature_findreplace_title'] = 'Localizar e Substituir';
$string['pro_feature_restrictions_desc'] = 'Atribua ou remova restrições de acesso em massa através de um menu intuitivo e centralizado.';
$string['pro_feature_restrictions_title'] = 'Controlo de Restrições';
$string['pro_feature_shift_desc'] = 'Desloque as datas de vencimento, início e fim de todas as suas atividades ou seleções específicas para a frente ou para trás em segundos.';
$string['pro_feature_shift_title'] = 'Mudança em Massa';
$string['pro_installed'] = 'Você tem a versão <strong>Pro</strong> instalada! Aproveite todos os recursos sem limites.';
$string['pro_subtitle'] = 'Esqueça de editar atividade por atividade. O TimeShift poupa-lhe horas de configuração.';
$string['pro_title'] = 'Atualizar para Timeshift Pro';
$string['pro_title_part1'] = 'Projetado para a';
$string['pro_title_part2'] = 'Produtividade';
